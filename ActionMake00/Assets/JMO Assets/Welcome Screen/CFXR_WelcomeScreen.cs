...
namespace CartoonFX
{
    ...
    public class CFXR_WelcomeScreen : EditorWindow
    {
        ...
        private void CreateGUI()
        {
            ...
            // UXML
            var uxmlDocument = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>(
            ...
            titleImage.image = AssetDatabase.LoadAssetAtPath<Texture2D>(
